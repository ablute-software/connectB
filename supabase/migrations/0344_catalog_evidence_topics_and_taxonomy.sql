...
-- em main), commit 5c0db67bef7ac22df25c8d06c781e3b560c81e5a, 2026-09-10
-- (Prompt 737, Fase 0A). NÃO foi preciso reconstruir por introspecção: o
-- ficheiro original foi encontrado intacto num branch remoto real que o
-- git log --all por nome/conteúdo tinha falhado em encontrar antes desta
-- procura. Verificado objecto a objecto contra produção em 2026-09-25
-- (enums, colunas, índices, políticas RLS, triggers, funções, constraints)
-- — zero diferenças confirmadas. O ledger de produção já contém esta
-- versão (supabase_migrations.schema_migrations); NÃO aplicar de novo.
-- Ver docs/parity_0344_0350_20260925.txt e DECISIONS.md (Prompt 737).
