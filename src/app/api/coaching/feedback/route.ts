...
export async function POST(req: Request) {
  ...
  try {
    ...
    await logAiCall({ route: '/api/coaching/feedback', purpose: 'coaching_feedback', model: process.env.AI_REVIEW_MODEL ?? 'claude-sonnet-4-5', usage: data.usage, orgId: member.org_id });
