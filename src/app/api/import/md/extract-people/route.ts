...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await logAiCall({ route: '/api/import/md/extract-people', purpose: 'import_extract_people', model: process.env.AI_REVIEW_MODEL ?? 'claude-sonnet-4-5', usage: data.usage, orgId: batch.org_id as string });
