'use client';
// Back-office — platform-admin view (developers): submission review queue,
// global catalog with verification state, and the distribution log
// (which investors were delivered to which orgs — prevents duplicate sends).
