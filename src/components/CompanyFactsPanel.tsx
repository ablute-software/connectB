'use client';
// IRM_SPEC §11 Company Canon management — the org's verified-truth archive
// the AI composer grounds every claim in. Batch 3 A moved this into Settings
// ("Company facts") — the facts are configuration the startup feeds; the
// Review & Optimization page consumes the confirmed ones. Add / confirm /
// edit-then-confirm / reject / supersede (never deleted, only superseded).
  ...
  return (
    <div className="space-y-4">
      <p className="text-xs text-gray-400">
        The verified truth the AI composer (and the Review &amp; Optimization ranking) grounds every claim in. Nothing here
        is asserted unless confirmed — superseding a fact keeps its history, since the change itself is often the best
        re-approach argument. {active.length} active fact{active.length === 1 ? '' : 's'}.
      </p>
