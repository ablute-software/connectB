'use client';
// Needs-review dossier + triage toolkit. Moved from
// src/app/needs-review/page.tsx (formerly its own route) into the Needs
// review/Outbox separadores on /queue — logic unchanged, only the export
// changed from a page default to a named panel.
//
// The dossier groups imported interactions by entity (left rail, pending
// counts) and shows the full chronological thread per entity for context. On
// top of the original classify-or-clear flow, each pending item carries:
