...
// When NEXT_PUBLIC_SUPABASE_URL is configured, swap this provider's load/save
// for the Supabase adapter (src/lib/supabase.ts) — the action semantics
// (locks, follow-up tasks, overrides, runs) are identical.
import React, { createContext, useContext, useEffect, useMemo, useState } from 'react';
import type {
  AccessGrant, Automation, AutomationRun, Channel, Classification, Db,
  DocumentItem, Entity, Interaction, InvestorSubmission, OverrideRule,
  PassReasonCategory, TaskItem,
} from './types';
