// Prompt 403 §C — v1's text verbatim (not one other word changed) plus a
// new Clause 6.3 ("Security scanning of uploaded documents") inserted
// after 6.2 (Disclosure control), with every following sub-clause of
// Clause 6 renumbered by one (old 6.3→6.4, 6.4→6.5, 6.5→6.6) and the one
// cross-reference to the old numbering (Clause 14.3, "including Clauses
// 6.3, 7...") updated to 6.4 to match. Same not-a-filesystem-read
// reasoning as v1.ts for why this is a plain exported string.
export const TERMS_V2_MARKDOWN = `# Sherlock Deal — Terms & Conditions of Use
